...
class Parser {
    ...
    public static function parsePEFile($handle) {
        ...
        echo var_dump(self::$headerMSDOS);
        echo var_dump(self::$headerCOFF);
        echo var_dump(self::$headerOptional);
        echo var_dump(self::$tableDataDirectory);
        echo var_dump(self::$tableSection);
