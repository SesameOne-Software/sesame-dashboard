...
function post_changelog($title, $additions, $changes, $removals, $notes) {
    $url = "https://discord.com/api/webhooks/800584433794678784/NqidLxOcYWCDXuwaAmLt-64lyu1GG3jLRb0FC5gtYPcdJomK4GnfND6QpwYVYmyiZORA"; 

    $hookObject = json_encode([
    "content" => $title,
    "username" => "sesame-network",
    "avatar_url" => "http://sesame.one/assets/img/logo.png",
    "tts" => false,
    "embeds" => [
        /*
         * Our first embed
        ...
        [
            "title" => "Changelogs:",
            "type" => "rich",
            "url" => "https://sesame.one/",
            "color" => hexdec( "cc52e0" ),
            "thumbnail" => [
                "url" => "http://sesame.one/assets/img/logo.png"
            ],
