<?php
	...
	if (!Helpers::unban($user))
		die(json_encode(array('success' => false, 'error' => 'Failed to unban user on forums.')));
	
	die(json_encode(array('success' => true, 'msg' => 'Successfully unbanned user on forums.')));
?>